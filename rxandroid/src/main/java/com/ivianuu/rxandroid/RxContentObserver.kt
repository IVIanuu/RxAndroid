...
object RxContentObserver {
    ...
    fun observe(
    ...
    ): Observable<Boolean> = Observable.create { e ->
        val observer = object : ContentObserver(handler) {
            ...
            override fun deliverSelfNotifications() = deliverSelfNotifications
        }
    ...
    fun <T> observe(
            ...
            observe(context, uri, handler, deliverSelfNotifications, notifyForDescendants)
                    .map { uri }
